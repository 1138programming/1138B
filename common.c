...
const float tolerance = 2.5; // 2.5% tolerance on encoder value. 5% of 139 inches (length of field) is 3 inches.
 ...
 *
 * Compute the average of two numbers. Determined using
...
void driveForward(float inches, tMotor leftMotor, tMotor rightMotor) {
